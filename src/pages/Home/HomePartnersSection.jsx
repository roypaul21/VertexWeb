...
export default function HomePartnersSection() {
    return(
        <section className="home-part-section">
            <h1 data-aos="slide-right"> OUR PARTNERS </h1>
            <div className="home-part-section-content">
                <div className="home-part-section-container">
